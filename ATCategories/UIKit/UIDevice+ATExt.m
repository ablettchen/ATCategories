...
- (NSString *)machineModelName {
    ...
    dispatch_once(&one, ^{
        ...
        NSDictionary *dic = @{
                              ...
                              @"Watch4,1" : @"Apple Watch Series 4 38mm",
                              @"Watch4,2" : @"Apple Watch Series 4 42mm",
                              @"Watch4,3" : @"Apple Watch Series 4 38mm",
                              @"Watch4,4" : @"Apple Watch Series 4 42mm",
