...
#import "NSDictionary+ATExt.h"
#import "NSString+ATExt.h"
#import "NSData+ATExt.h"



@interface _ATXMLDictionaryParser : NSObject <NSXMLParserDelegate>
@end

@implementation _ATXMLDictionaryParser {
...
@implementation NSDictionary (ATExt)
...
+ (NSDictionary *)dictionaryWithXML:(id)xml {
    _ATXMLDictionaryParser *parser = nil;
    if ([xml isKindOfClass:[NSString class]]) {
        parser = [[_ATXMLDictionaryParser alloc] initWithString:xml];
    } else if ([xml isKindOfClass:[NSData class]]) {
        parser = [[_ATXMLDictionaryParser alloc] initWithData:xml];
    }
...
@implementation NSMutableDictionary (ATExt)
